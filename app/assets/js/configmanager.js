...
/**
 * Retrieve the music volume setting.
 * 
 * @param {boolean} def Optional. If true, the default value will be returned.
 * @returns {number} The music volume (0-100).
 */
exports.getMusicVolume = function(def = false){
    return !def ? config.settings.game.musicVolume : DEFAULT_CONFIG.settings.game.musicVolume
}

/**
 * Set the music volume setting.
 * 
 * @param {number} musicVolume The new music volume (0-100).
 */
exports.setMusicVolume = function(musicVolume){
    config.settings.game.musicVolume = Number.parseInt(musicVolume)
}
